  ...
  const saveDialogue = () => {
    ...
    if (mode === "complete") {
      ...
      if (hasMissingResponses) {
        alert("Please fill in expected responses for all lines");
        return;
      }
    }
      ...
      <Card className="border-0 shadow-md">
        ...
        <CardContent className="p-0">
          <Tabs
            ...
            className="w-full"
          >
            <TabsList className="grid w-full grid-cols-3 rounded-none bg-orange-50">
              <TabsTrigger
                value="setup"
            ...
            <TabsContent value="setup" className="p-6 space-y-6">
                  ...
                  <div className="flex gap-2">
                    {(["easy", "medium", "hard"] as const).map((level) => (
                      <Button
                        ...
                        className={difficulty === level ? "bg-orange-600" : ""}
                      >
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="resize-none focus:ring-2 focus:ring-orange-500 bg-amber-50"
                  rows={3}
                />
              </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {speakers.map((speaker, idx) => (
                    <Badge
                      key={idx}
                      variant="secondary"
                      className="px-2  py-3 flex items-center bg-orange-100 text-orange-700"
                    >
                  ...
                  {(["complete", "order", "roleplay"] as const).map(m => (
                    <Card
                      ...
                      className={`cursor-pointer transition-all border-2 ${
                        mode === m ? "border-orange-500 bg-orange-50" : "border-slate-200"
                      }`}
                      onClick={() => setMode(m)}
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {lines.map((line, index) => (
                    <Card
                      key={line.id}
                      className="relative border-l-4 border-l-orange-400"
                    >
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 space-y-3">
                            ...
                            {mode === "complete" && (
                              <div className="space-y-2 pl-4 border-l-2 border-dashed border-orange-200">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-50 rounded-lg">
                  ...
                  <div className="mt-3 flex gap-2">
                    ...
                    <Badge variant="outline">{speakers.length} speakers</Badge>
                    <Badge variant="outline">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2">
                        <Badge className="bg-orange-500">Dialogue</Badge>
